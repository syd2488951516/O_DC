...
namespace ART_OLC {
    ...
    public:
       ...
       static TID crack(IndexEntry *&c,uint64_t value, N *first,N *second,
                               uint64_t limit,ThreadInfo &threadInfo, bool &needRestart);
    ...
    public:
        ...
        N* LookupLT(const Key &k, N *&first,N *&second,ThreadInfo &threadInfo, uint64_t kk, 
                               IndexEntry *&c,uint64_t limit,uint64_t &position) const;
