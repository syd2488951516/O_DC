...
namespace ART_OLC {
    ...
    void N256::insert(uint8_t key, N *val) {
        ...
        // printf("insert N256\n");
        // if(val->getType() == NTypes::Nleaf){
        //     printf("True\n");
        // }
        // if(val->getType() == NTypes::N4){
        //     printf("False\n");
        // }
    }
    ...
    N *N256::getMinChild() const{// add function
        return children[minl];
    }

    N *N256::getMaxChild() const{// add function
        return children[maxr];
    }
